...
In 2016 COL could cover more of the offensive field and they were more active in compare to 202. in 2020 they could reach the other teams crease more often and do shotes from near the goal box. (most of the shots were made from a close distance from the goal box), and in both years they tried to reach the goal box from sides of the rink.
...
for TBL most of the shots happened from the goal box which means the chance of shots being goal is high, but for BUF shots happened from every part of the offensive field and in 2020 it got worst. 
the cencentrate in thw goal box decreased and shots got spread over the offensive fieald. 

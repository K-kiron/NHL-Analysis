...
### gameSeconds: int val of number of seconds into the game
### period: int val of the period
### x_coordinate: float x coordinate of the event
### y_coordinate: float y coordinate of the event
### shotDistance: distance between the event and the net
### shotAngle: counter-clockwise angle between the event and the goal with respect to the x-axis
### shotType: type of shot (ex: Wrist Shot, Slap Shot)
### LastEventType: Type of the previous event (ex: Shot, Goal)
### Last_x_coordinate: float x coordinate of the previous event
### Last_y_coordinate: float y coordinate of the previous event
### timeFromLastEvent: time interval between the current and previous event
### DistanceLastEvent: distance between the current and previous event
### Rebound: bool value for if the shot was a rebound or not 
### changeShotAngle: if Rebound = True, change in the angle of the puck before and after the rebound
### speed: speed between current and previous event corresponding to DistanceLastEvent/timeFromLastEvent
